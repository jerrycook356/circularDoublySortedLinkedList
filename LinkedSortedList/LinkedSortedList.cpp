...
LinkedSortedList<ItemType>::LinkedSortedList() : headPtr(nullptr), tailPtr (nullptr), itemCount(0)
{
...
Node<ItemType>* LinkedSortedList<ItemType>::copyChain(const Node<ItemType>* origChainPtr)
{
   Node<ItemType>* copiedChainPtr = nullptr;
	if (origChainPtr != nullptr)
	{
		...
		if (origChainPtr->getPrev() != nullptr)
		{
			copiedChainPtr->setPrev(origChainPtr->getPrev());
		}
...
template<class ItemType>
void LinkedSortedList<ItemType>::traverseBackwards()
{
...
template<class ItemType>
void LinkedSortedList<ItemType>::traverseFoward()
{
